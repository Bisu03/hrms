...
const AddExpencecategory = () => {
    ...
    const HandleSubmit = async () => {
        setLoading(true)
        try {
            const { data } = await apiRequest.post("/api/expence/category", {
                name: Name
            })
            setName("")
            refetch()
                                    ...
                                    <tr key={key}>
                                        ...
                                        <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div className="flex items-center space-x-3.5">
                                                ...
                                                <Link href={`/expence/updatecategory/${data._id}`}>
                                                    <FaEdit />
                                                </Link>
...
AddExpencecategory.adminRoute = true
